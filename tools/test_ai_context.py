...
class ContextRouterTest(unittest.TestCase):
    ...
    def test_01_known_inventory_is_stable_and_unique(self):
        ...
        self.assertEqual(105, len(rows))
        self.assertEqual(105, len({row["id"] for row in rows}))
    ...
    def test_02b_history_scan_independently_counts_105_primary_findings(self):
        ...
        self.assertEqual(105, len(found))

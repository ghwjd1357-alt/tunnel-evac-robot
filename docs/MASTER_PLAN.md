...
1. ~~**SpeedManager 추출**~~ ✅ 완료 (07-20 — 구현 `f94da44` + Codex 독립 검토 P1 보완.
   기록 = `0720_현황.md §19` 구현 · `§20` 검토 · `§21` 보완)
...
| 속도 timeout = "적용 확인까지 총 30초" (서비스 미준비·응답 무응답 동일 처리) | 07-20 | `0720_현황.md §20.5` |
| 비동기 요청은 desired/applied 분리 + 종결 재평가 (restore·reconcile 한정, 유한 종결) | 07-20 | `0720_현황.md §21.2` |
